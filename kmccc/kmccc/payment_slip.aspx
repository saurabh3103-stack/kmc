<%@ Page Language="C#" AutoEventWireup="true" CodeFile="payment_slip.aspx.cs" Inherits="payment_slip" %>
...
h3.text-color.bill-heading{margin: 0 !important;}
        ...
        <asp:Label ID="pTxnId" runat="server" Text="Label"></asp:Label>
        <asp:Label ID="pOrderId" runat="server" Text="Label"></asp:Label>
        <asp:Label ID="h1Message" runat="server" Text="Label"></asp:Label>
		  <section id="content">
                	<div class="main">
